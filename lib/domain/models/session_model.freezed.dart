...
mixin _$SessionModel {
 ...
 String? get accessToken; String? get tokenType; int? get expiresIn; String? get refreshToken; UserModel? get user;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,accessToken,tokenType,expiresIn,refreshToken,user);

@override
String toString() {
  return 'SessionModel(accessToken: $accessToken, tokenType: $tokenType, expiresIn: $expiresIn, refreshToken: $refreshToken, user: $user)';
}
...
@useResult
$Res call({
 String? accessToken, String? tokenType, int? expiresIn, String? refreshToken, UserModel? user
});
...
/// Create a copy of SessionModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? accessToken = freezed,Object? tokenType = freezed,Object? expiresIn = freezed,Object? refreshToken = freezed,Object? user = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? accessToken,  String? tokenType,  int? expiresIn,  String? refreshToken,  UserModel? user)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SessionModel() when $default != null:
return $default(_that.accessToken,_that.tokenType,_that.expiresIn,_that.refreshToken,_that.user);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? accessToken,  String? tokenType,  int? expiresIn,  String? refreshToken,  UserModel? user)  $default,) {final _that = this;
switch (_that) {
case _SessionModel():
return $default(_that.accessToken,_that.tokenType,_that.expiresIn,_that.refreshToken,_that.user);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? accessToken,  String? tokenType,  int? expiresIn,  String? refreshToken,  UserModel? user)?  $default,) {final _that = this;
switch (_that) {
case _SessionModel() when $default != null:
return $default(_that.accessToken,_that.tokenType,_that.expiresIn,_that.refreshToken,_that.user);case _:
  return null;
...
class _SessionModel implements SessionModel {
  const _SessionModel({this.accessToken, this.tokenType, this.expiresIn, this.refreshToken, this.user});
...
/// Create a copy of SessionModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? accessToken = freezed,Object? tokenType = freezed,Object? expiresIn = freezed,Object? refreshToken = freezed,Object? user = freezed,}) {
